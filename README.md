...
The API endpoints are:
	...
	HTTP POST:  http://localhost:3080/1/request?child1=...&child2=...
	...
	HTTP POST:  http://localhost:3080/1/approve?parent=...&child1=...&child2=...
	...
	HTTP POST:  http://localhost:3080/1/view?parentOrChild=...
	...
	HTTP POST:  http://localhost:3080/1/log?parent=...&child1=...&child2=...
	
	This is called by a parent to view the recent chat messages for a given connection
	between child1 and child2.
	
	HTTP POST:  http://localhost:3080/1/block?parent=...&child1=...&child2=...
	...
	HTTP POST:  http://localhost:3080/1/unblock?parent=...&child1=...&child2=...
	...
	HTTP POST:  http://localhost:3080/1/delete?parent=...&child1=...&child2=...
	...
	ws://localhost:3080/1/chat/child1/child2
	ws://localhost:3080/1/chat/child2/child1
